...
public sealed class ReserveParkingSpotForVehicleHandler : ICommandHandler<ReserveParkingSpotForVehicle>
{
    ...
    public async Task HandleAsync(Commands.ReserveParkingSpotForVehicle command)
    {
        ...
        var parkingSpotToReserve = weeklyParkingSpot.SingleOrDefault(x => x.Id == parkingSpotId);
        ...
        _reservationService.ReserveSpotForVehicle(weeklyParkingSpot, JobTitle.Employee,
